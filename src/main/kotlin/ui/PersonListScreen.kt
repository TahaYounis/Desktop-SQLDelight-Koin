...
fun PersonListScreen() {
    val viewModel = get<PersonListViewModel>(PersonListViewModel::class.java)
...
//                viewModel.personDetails.let { personDetails ->
//                    Dialog(onCloseRequest = viewModel::onPersonDetailsDialogDismiss) {
//                        Box(
//                            modifier = Modifier
//                                .fillMaxWidth()
...
//                        ) {
//                            Text(text = "${personDetails?.firstName} ${personDetails?.lastName}")
//                        }
//                    }
//                }
            }
